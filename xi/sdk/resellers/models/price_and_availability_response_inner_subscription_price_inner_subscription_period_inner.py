...
class PriceAndAvailabilityResponseInnerSubscriptionPriceInnerSubscriptionPeriodInner(BaseModel):
    """
    PriceAndAvailabilityResponseInnerSubscriptionPriceInnerSubscriptionPeriodInner
    """ # noqa: E501
    subscription_period_unit: Optional[StrictStr] = Field(default=None, description="The unit of the subscription period.", alias="subscriptionPeriodUnit")
    subscription_period: Optional[StrictStr] = Field(default=None, description="The subscription period value.", alias="subscriptionPeriod")
