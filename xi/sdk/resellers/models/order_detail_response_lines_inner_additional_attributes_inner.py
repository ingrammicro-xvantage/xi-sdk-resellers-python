...
class OrderDetailResponseLinesInnerAdditionalAttributesInner(BaseModel):
    """
    OrderDetailResponseLinesInnerAdditionalAttributesInner
    """ # noqa: E501
    attribute_name: Optional[StrictStr] = Field(default=None, description="Line level custom field names.", alias="attributeName")
    attribute_value: Optional[StrictStr] = Field(default=None, description="Value of the custom fields.", alias="attributeValue")
