...
class InvoiceDetailResponseServiceresponseInvoicedetailresponseMiscfeelineInner(BaseModel):
    """
    InvoiceDetailResponseServiceresponseInvoicedetailresponseMiscfeelineInner
    """ # noqa: E501
    code: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    chargeamount: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["code", "description", "chargeamount"]
