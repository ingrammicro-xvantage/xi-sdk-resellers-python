...
class OrderModifyRequestServicerequestOrdermodifyrequestShipto(BaseModel):
    """
    OrderModifyRequestServicerequestOrdermodifyrequestShipto
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="Id")
    name: Optional[StrictStr] = None
    addressline: Optional[StrictStr] = None
    city: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    postalcode: Optional[StrictStr] = None
    countrycode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["Id", "name", "addressline", "city", "state", "postalcode", "countrycode"]
