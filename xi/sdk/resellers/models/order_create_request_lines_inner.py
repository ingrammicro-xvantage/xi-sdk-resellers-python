...
class OrderCreateRequestLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "additionalAttributes": [OrderCreateRequestLinesInnerAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None,
            "warrantyInfo": [OrderCreateRequestLinesInnerWarrantyInfoInner.from_dict(_item) for _item in obj.get("warrantyInfo")] if obj.get("warrantyInfo") is not None else None,
            "endUserInfo": [OrderCreateRequestLinesInnerEndUserInfoInner.from_dict(_item) for _item in obj.get("endUserInfo")] if obj.get("endUserInfo") is not None else None
        })
        return _obj
