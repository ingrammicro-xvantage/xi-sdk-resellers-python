...
class OrderCreateRequestShipToInfo(BaseModel):
    """
    ...
    address_line3: Optional[Annotated[str, Field(strict=True, max_length=70)]] = Field(default=None, description="Line 3 of the address the order will be shipped to.", alias="addressLine3")
    ...
    country_code: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(default=None, description="The two-character ISO country code the order will be shipped to.", alias="countryCode")
