...
class OrderSearchRequestServicerequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "requestpreamble": OrderSearchRequestServicerequestRequestpreamble.from_dict(obj.get("requestpreamble")) if obj.get("requestpreamble") is not None else None,
            "orderLookupRequest": OrderSearchRequestServicerequestOrderLookupRequest.from_dict(obj.get("orderLookupRequest")) if obj.get("orderLookupRequest") is not None else None
        })
        return _obj
