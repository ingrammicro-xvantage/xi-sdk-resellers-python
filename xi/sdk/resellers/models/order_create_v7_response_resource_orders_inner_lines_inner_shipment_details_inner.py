...
class OrderCreateV7ResponseResourceOrdersInnerLinesInnerShipmentDetailsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["carrierCode", "carrierName", "shipFromWarehouseId", "shipFromLocation"]
