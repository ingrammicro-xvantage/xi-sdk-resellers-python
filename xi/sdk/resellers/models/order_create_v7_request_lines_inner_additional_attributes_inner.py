...
class OrderCreateV7RequestLinesInnerAdditionalAttributesInner(BaseModel):
    """
    ...
    attribute_value: Optional[StrictStr] = Field(default=None, description="TLine-level additional attributes.", alias="attributeValue")
