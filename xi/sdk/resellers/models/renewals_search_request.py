...
class RenewalsSearchRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "status": RenewalsSearchRequestStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None,
            "dataType": RenewalsSearchRequestDataType.from_dict(obj.get("dataType")) if obj.get("dataType") is not None else None,
