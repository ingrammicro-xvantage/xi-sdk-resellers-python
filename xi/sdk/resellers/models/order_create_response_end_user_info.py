...
class OrderCreateResponseEndUserInfo(BaseModel):
    """
    The contact information for the end user/customer provided by the reseller. Used to determine pricing and discounts.
    """ # noqa: E501
    end_user_id: Optional[StrictStr] = Field(default=None, description="The unique ID provided by the reseller for the end user/customer.", alias="endUserId")
