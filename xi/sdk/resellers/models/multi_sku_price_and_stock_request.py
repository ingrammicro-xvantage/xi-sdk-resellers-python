...
class MultiSKUPriceAndStockRequest(BaseModel):
    """
    Request object model for the multi sku price and stock API endpoint
    """ # noqa: E501
    servicerequest: Optional[MultiSKUPriceAndStockRequestServicerequest] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "servicerequest": MultiSKUPriceAndStockRequestServicerequest.from_dict(obj.get("servicerequest")) if obj.get("servicerequest") is not None else None
        })
        return _obj
