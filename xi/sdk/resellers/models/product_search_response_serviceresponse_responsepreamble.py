...
class ProductSearchResponseServiceresponseResponsepreamble(BaseModel):
    """
    ProductSearchResponseServiceresponseResponsepreamble
    """ # noqa: E501
    requeststatus: Optional[StrictStr] = None
    returncode: Optional[StrictStr] = None
    returnmessage: Optional[StrictStr] = None
