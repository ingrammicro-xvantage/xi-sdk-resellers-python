...
class OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerEnduser(BaseModel):
    """
    ...
    extensionnumber: Optional[StrictStr] = None
    faxnumber: Optional[StrictStr] = None
    email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "addressline1", "addressline2", "addressline3", "city", "state", "postalcode", "countrycode", "phonenumber", "extensionnumber", "faxnumber", "email"]
