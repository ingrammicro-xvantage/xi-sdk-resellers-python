...
class PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner(BaseModel):
    ...
    def var_class_validate_enum(cls, value):
        ...
        if value not in ('A', 'B', 'C', 'D', 'E', 'F', 'N', 'O', 'S', 'V', 'X'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "warehousedetails": [WarehouseListType.from_dict(_item) for _item in obj.get("warehousedetails")] if obj.get("warehousedetails") is not None else None
        })
        return _obj
