...
class OrderModifyRequestAdditionalAttributesInner(BaseModel):
    """
    OrderModifyRequestAdditionalAttributesInner
    """ # noqa: E501
    attribute_name: Optional[StrictStr] = Field(default=None, description="Example values are 'entryMethod', 'enableCommentsAsLines', 'regionCode'", alias="attributeName")
