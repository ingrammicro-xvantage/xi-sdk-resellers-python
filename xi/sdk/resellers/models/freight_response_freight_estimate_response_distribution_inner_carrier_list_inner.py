...
class FreightResponseFreightEstimateResponseDistributionInnerCarrierListInner(BaseModel):
    ...
    estimated_freight_charge: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Estimated freight charge.", alias="estimatedFreightCharge")
    days_in_transit: Optional[StrictInt] = Field(default=None, description="Number of transit days.", alias="daysInTransit")
