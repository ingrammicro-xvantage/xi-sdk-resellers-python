...
class OrderCreateV7RequestLinesInnerWarrantyInfo(BaseModel):
    """
    ...
    serial_info: Optional[List[OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner]] = Field(default=None, alias="serialInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serialInfo": [OrderCreateV7RequestLinesInnerWarrantyInfoSerialInfoInner.from_dict(_item) for _item in obj["serialInfo"]] if obj.get("serialInfo") is not None else None
        })
        return _obj
