...
class ReturnsCreateRequestListInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipFromInfo": [ReturnsCreateRequestListInnerShipFromInfoInner.from_dict(_item) for _item in obj.get("shipFromInfo")] if obj.get("shipFromInfo") is not None else None,
