...
class InvoiceDetailRequest(BaseModel):
    ...
    """ # noqa: E501
    servicerequest: Optional[InvoiceDetailRequestServicerequest] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "servicerequest": InvoiceDetailRequestServicerequest.from_dict(obj.get("servicerequest")) if obj.get("servicerequest") is not None else None
        })
        return _obj
