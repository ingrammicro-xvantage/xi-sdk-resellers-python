...
class OrderCreateRequestEndUserInfo(BaseModel):
    """
    ...
    contact: Optional[Annotated[str, Field(strict=True, max_length=70)]] = Field(default=None, description="The contact name for the end user/customer.")
    ...
    address_line3: Optional[Annotated[str, Field(strict=True, max_length=70)]] = Field(default=None, description="Line 3 of the address for the end user/customer.", alias="addressLine3")
