...
class OrderDetailResponseServiceresponseOrderdetailresponseCommentlinesInner(BaseModel):
    """
    OrderDetailResponseServiceresponseOrderdetailresponseCommentlinesInner
    """ # noqa: E501
    commenttext1: Optional[StrictStr] = None
    commenttext2: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["commenttext1", "commenttext2"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "commenttext1": obj.get("commenttext1"),
            "commenttext2": obj.get("commenttext2")
        })
        return _obj
