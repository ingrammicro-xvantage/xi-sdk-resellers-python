...
class OrderDetailB2BLinesInnerServiceContractInfo(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "contractInfo": OrderDetailB2BLinesInnerServiceContractInfoContractInfo.from_dict(obj.get("contractInfo")) if obj.get("contractInfo") is not None else None,
            "subscriptions": OrderDetailB2BLinesInnerServiceContractInfoSubscriptions.from_dict(obj.get("subscriptions")) if obj.get("subscriptions") is not None else None,
            "licenseInfo": OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo.from_dict(obj.get("licenseInfo")) if obj.get("licenseInfo") is not None else None
        })
        return _obj
