...
class OrderDetailResponseEndUserInfo(BaseModel):
    """
    ...
    address_line1: Optional[StrictStr] = Field(default=None, description="The street adress and building or house number for the end user/customer.", alias="addressLine1")
    address_line2: Optional[StrictStr] = Field(default=None, description="The apartment number for the end user/customer.", alias="addressLine2")
