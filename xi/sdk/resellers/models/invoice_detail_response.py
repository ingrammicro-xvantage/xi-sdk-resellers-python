...
class InvoiceDetailResponse(BaseModel):
    ...
    """ # noqa: E501
    serviceresponse: Optional[InvoiceDetailResponseServiceresponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "serviceresponse": InvoiceDetailResponseServiceresponse.from_dict(obj.get("serviceresponse")) if obj.get("serviceresponse") is not None else None
        })
        return _obj
