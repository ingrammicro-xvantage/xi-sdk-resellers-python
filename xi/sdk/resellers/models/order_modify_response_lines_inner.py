...
class OrderModifyResponseLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipmentDetails": OrderModifyResponseLinesInnerShipmentDetails.from_dict(obj.get("shipmentDetails")) if obj.get("shipmentDetails") is not None else None,
            "additionalAttributes": [OrderModifyResponseLinesInnerAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None,
            "notes": obj.get("notes")
        })
        return _obj
