...
class VendorRequiredInfoRequest(BaseModel):
    """
    ...
    products: Optional[List[VendorRequiredInfoRequestProductsInner]] = None
    __properties: ClassVar[List[str]] = ["quoteNumber", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [VendorRequiredInfoRequestProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
