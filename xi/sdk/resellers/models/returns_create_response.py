...
class ReturnsCreateResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "returnsClaims": [ReturnsCreateResponseReturnsClaimsInner.from_dict(_item) for _item in obj.get("returnsClaims")] if obj.get("returnsClaims") is not None else None
        })
        return _obj
