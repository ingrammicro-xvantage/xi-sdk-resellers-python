...
class OrderSearchResponseServiceResponseResponsepreamble(BaseModel):
    """
    OrderSearchResponseServiceResponseResponsepreamble
    """ # noqa: E501
    requeststatus: StrictStr
    returnmessage: StrictStr
    __properties: ClassVar[List[str]] = ["requeststatus", "returnmessage"]
