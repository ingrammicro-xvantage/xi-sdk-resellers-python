...
class PostQuoteToOrderV6400Response(BaseModel):
    """
    ...
    fields: Optional[List[PostQuoteToOrderV6400ResponseFieldsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [PostQuoteToOrderV6400ResponseFieldsInner.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None
        })
        return _obj
