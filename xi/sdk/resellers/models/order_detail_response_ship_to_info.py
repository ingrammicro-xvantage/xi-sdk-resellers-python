...
class OrderDetailResponseShipToInfo(BaseModel):
    """
    ...
    address_line1: Optional[StrictStr] = Field(default=None, description="The street address the order will be shipped to.", alias="addressLine1")
    address_line2: Optional[StrictStr] = Field(default=None, description="The building or apartment number the order will be shipped to.", alias="addressLine2")
