...
class OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInnerPackagedetails(BaseModel):
    """
    OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerShipmentdetailsInnerPackagedetails
    """ # noqa: E501
    trackingnumber: Optional[StrictStr] = None
    packageweight: Optional[StrictStr] = None
    cartonnumber: Optional[StrictStr] = None
    quantityinbox: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["trackingnumber", "packageweight", "cartonnumber", "quantityinbox"]
