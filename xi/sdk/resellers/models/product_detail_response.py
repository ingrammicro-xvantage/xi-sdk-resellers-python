...
class ProductDetailResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cisco_fields:
            for _item in self.cisco_fields:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "indicators": [ProductDetailResponseIndicatorsInner.from_dict(_item) for _item in obj.get("indicators")] if obj.get("indicators") is not None else None,
            "ciscoFields": [ProductDetailResponseCiscoFieldsInner.from_dict(_item) for _item in obj.get("ciscoFields")] if obj.get("ciscoFields") is not None else None,
            "technicalSpecifications": [ProductDetailResponseTechnicalSpecificationsInner.from_dict(_item) for _item in obj.get("technicalSpecifications")] if obj.get("technicalSpecifications") is not None else None,
            "warrantyInformation": obj.get("warrantyInformation"),
            "additionalInformation": ProductDetailResponseAdditionalInformation.from_dict(obj.get("additionalInformation")) if obj.get("additionalInformation") is not None else None
        })
        return _obj
