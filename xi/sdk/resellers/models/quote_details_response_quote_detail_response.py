...
class QuoteDetailsResponseQuoteDetailResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "retrieveQuoteResponse": QuoteDetailsResponseQuoteDetailResponseRetrieveQuoteResponse.from_dict(obj["retrieveQuoteResponse"]) if obj.get("retrieveQuoteResponse") is not None else None
        })
        return _obj
