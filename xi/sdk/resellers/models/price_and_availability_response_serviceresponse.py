...
class PriceAndAvailabilityResponseServiceresponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priceandstockresponse": PriceAndAvailabilityResponseServiceresponsePriceandstockresponse.from_dict(obj["priceandstockresponse"]) if obj.get("priceandstockresponse") is not None else None
        })
        return _obj
