...
class InvoiceDetailsv61ResponseLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "serialNumbers": [InvoiceDetailsv61ResponseLinesInnerSerialNumbersInner.from_dict(_item) for _item in obj.get("serialNumbers")] if obj.get("serialNumbers") is not None else None,
