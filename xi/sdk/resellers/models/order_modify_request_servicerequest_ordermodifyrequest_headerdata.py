...
class OrderModifyRequestServicerequestOrdermodifyrequestHeaderdata(BaseModel):
    """
    OrderModifyRequestServicerequestOrdermodifyrequestHeaderdata
    """ # noqa: E501
    actioncode: Optional[StrictStr] = None
    shipviacode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["actioncode", "shipviacode"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipviacode": obj.get("shipviacode")
        })
        return _obj
