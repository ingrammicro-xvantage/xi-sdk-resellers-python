...
class OrderDetailB2BLinesInnerEstimatedDatesInnerDelivery(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "deliveryDateRange": OrderDetailB2BLinesInnerEstimatedDatesInnerDeliveryDeliveryDateRange.from_dict(obj.get("deliveryDateRange")) if obj.get("deliveryDateRange") is not None else None,
