...
class PriceAndAvailabilityResponseServiceresponsePriceandstockresponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [PriceAndAvailabilityResponseServiceresponsePriceandstockresponseDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
