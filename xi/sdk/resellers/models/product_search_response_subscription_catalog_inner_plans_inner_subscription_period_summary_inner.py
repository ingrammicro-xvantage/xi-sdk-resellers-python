...
class ProductSearchResponseSubscriptionCatalogInnerPlansInnerSubscriptionPeriodSummaryInner(BaseModel):
    """
    ProductSearchResponseSubscriptionCatalogInnerPlansInnerSubscriptionPeriodSummaryInner
    """ # noqa: E501
    subscription_period_unit: Optional[StrictStr] = Field(default=None, description="Provides the details of the product.", alias="subscriptionPeriodUnit")
    subscription_period: Optional[StrictStr] = Field(default=None, description="The URL endpoint for accessing the relevant data..", alias="subscriptionPeriod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptionPeriodUnit": obj.get("subscriptionPeriodUnit"),
