...
class OrderDetailB2BAdditionalAttributesInner(BaseModel):
    """
    OrderDetailB2BAdditionalAttributesInner
    """ # noqa: E501
    attribute_name: Optional[StrictStr] = Field(default=None, description="Header level custom field names.", alias="attributeName")
