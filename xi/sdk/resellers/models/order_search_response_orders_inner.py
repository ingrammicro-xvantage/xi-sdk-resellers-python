...
class OrderSearchResponseOrdersInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "subOrders": [OrderSearchResponseOrdersInnerSubOrdersInner.from_dict(_item) for _item in obj.get("subOrders")] if obj.get("subOrders") is not None else None,
            "links": OrderSearchResponseOrdersInnerLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
