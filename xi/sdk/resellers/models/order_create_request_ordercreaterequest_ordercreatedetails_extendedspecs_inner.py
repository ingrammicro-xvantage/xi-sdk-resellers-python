...
class OrderCreateRequestOrdercreaterequestOrdercreatedetailsExtendedspecsInner(BaseModel):
    ...
    def attributename_validate_enum(cls, value):
        ...
        if value not in set(['Isdirectshiporder', 'emailaddress', 'Isbackorderflagallowed', 'placeoncustomerhold', 'signaturerequired', 'commenttext', 'resellerctacemail', 'duplicatecustomerordernumbervalidate', 'quotenumber', 'shipctacphone', 'vendauthnumber', 'continueonerror']):
