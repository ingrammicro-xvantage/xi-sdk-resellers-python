...
class PriceAndAvailabilityResponseInnerDiscountsInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "specialPricing": [PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner.from_dict(_item) for _item in obj.get("specialPricing")] if obj.get("specialPricing") is not None else None,
            "quantityDiscounts": [PriceAndAvailabilityResponseInnerDiscountsInnerQuantityDiscountsInner.from_dict(_item) for _item in obj.get("quantityDiscounts")] if obj.get("quantityDiscounts") is not None else None
        })
        return _obj
