...
class FreightRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipToAddress": [FreightRequestShipToAddressInner.from_dict(_item) for _item in obj.get("shipToAddress")] if obj.get("shipToAddress") is not None else None,
            "lines": [FreightRequestLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None
        })
        return _obj
