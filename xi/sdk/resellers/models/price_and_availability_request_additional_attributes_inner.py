...
class PriceAndAvailabilityRequestAdditionalAttributesInner(BaseModel):
    """
    PriceAndAvailabilityRequestAdditionalAttributesInner
    """ # noqa: E501
    attribute_name: Optional[StrictStr] = Field(default=None, description="key value pair -key Name.", alias="attributeName")
