...
class MultiSKUPriceAndStockResponse(BaseModel):
    """
    Response object model for the multi sku price and stock API endpoint
    """ # noqa: E501
    serviceresponse: Optional[MultiSKUPriceAndStockResponseServiceresponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "serviceresponse": MultiSKUPriceAndStockResponseServiceresponse.from_dict(obj.get("serviceresponse")) if obj.get("serviceresponse") is not None else None
        })
        return _obj
