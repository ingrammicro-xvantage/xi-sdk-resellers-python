...
class OrderModifyRequestServicerequestOrdermodifyrequestLinedataInner(BaseModel):
    """
    OrderModifyRequestServicerequestOrdermodifyrequestLinedataInner
    """ # noqa: E501
    addlineorupdateline: Optional[StrictStr] = None
    linenumber: Optional[StrictStr] = None
    customerlinenumber: Optional[StrictStr] = None
    ingrampartnumber: Optional[StrictStr] = None
    quantityordered: Optional[StrictInt] = None
    customerpartnumber: Optional[StrictStr] = None
    linetype: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["addlineorupdateline", "linenumber", "customerlinenumber", "ingrampartnumber", "quantityordered", "customerpartnumber", "linetype"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "addlineorupdateline": obj.get("addlineorupdateline"),
