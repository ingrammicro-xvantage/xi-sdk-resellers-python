...
class OrderCreateResponse(BaseModel):
    ...
    """ # noqa: E501
    serviceresponse: Optional[OrderCreateResponseServiceresponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "serviceresponse": OrderCreateResponseServiceresponse.from_dict(obj.get("serviceresponse")) if obj.get("serviceresponse") is not None else None
        })
        return _obj
