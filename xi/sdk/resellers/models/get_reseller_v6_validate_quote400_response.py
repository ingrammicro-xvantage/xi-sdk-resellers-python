...
class GetResellerV6ValidateQuote400Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [GetResellerV6ValidateQuote400ResponseFieldsInner.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None
        })
        return _obj
