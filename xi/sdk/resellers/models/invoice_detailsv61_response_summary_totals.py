...
class InvoiceDetailsv61ResponseSummaryTotals(BaseModel):
    """
    InvoiceDetailsv61ResponseSummaryTotals
    """ # noqa: E501
    net_invoice_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net Invoice amount.", alias="netInvoiceAmount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "netInvoiceAmount": obj.get("netInvoiceAmount"),
