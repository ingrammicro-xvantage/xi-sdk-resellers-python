...
class GetAccesstoken500ResponseFault(BaseModel):
    """
    GetAccesstoken500ResponseFault
    """ # noqa: E501
    faultstring: Optional[StrictStr] = None
    detail: Optional[GetAccesstoken500ResponseFaultDetail] = None
    __properties: ClassVar[List[str]] = ["faultstring", "detail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "faultstring": obj.get("faultstring"),
            "detail": GetAccesstoken500ResponseFaultDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None
        })
        return _obj
