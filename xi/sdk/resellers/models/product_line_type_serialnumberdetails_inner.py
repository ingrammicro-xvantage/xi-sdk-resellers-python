...
class ProductLineTypeSerialnumberdetailsInner(BaseModel):
    """
    ProductLineTypeSerialnumberdetailsInner
    """ # noqa: E501
    serialnumber: Optional[StrictStr] = None
    deliverynumber: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["serialnumber", "deliverynumber"]
