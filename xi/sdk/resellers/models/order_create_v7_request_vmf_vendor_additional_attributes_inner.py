...
class OrderCreateV7RequestVmfVendorAdditionalAttributesInner(BaseModel):
    """
    ...
    product_id: Optional[StrictStr] = Field(default=None, description="The Product ID from the vendor", alias="productId")
    additional_attributes: Optional[List[OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner]] = Field(default=None, alias="additionalAttributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalAttributes": [OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner.from_dict(_item) for _item in obj["additionalAttributes"]] if obj.get("additionalAttributes") is not None else None
        })
        return _obj
