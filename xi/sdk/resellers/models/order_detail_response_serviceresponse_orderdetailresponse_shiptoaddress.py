...
class OrderDetailResponseServiceresponseOrderdetailresponseShiptoaddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["suffix", "attention", "name", "addressline1", "addressline2", "addressline3", "city", "state", "postalcode", "countrycode"]
