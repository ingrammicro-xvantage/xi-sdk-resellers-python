...
class OrderCancelResponseServiceresponse(BaseModel):
    """
    OrderCancelResponseServiceresponse
    """ # noqa: E501
    responsepreamble: Optional[OrderCancelResponseServiceresponseResponsepreamble] = None
    __properties: ClassVar[List[str]] = ["responsepreamble"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "responsepreamble": OrderCancelResponseServiceresponseResponsepreamble.from_dict(obj.get("responsepreamble")) if obj.get("responsepreamble") is not None else None
        })
        return _obj
