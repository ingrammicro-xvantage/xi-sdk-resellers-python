...
class OrderCreateResponseServiceresponseOrdersummaryShiptoaddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attention", "name", "addressline1", "addressline2", "addressline3", "city", "state", "postalcode", "countrycode"]
