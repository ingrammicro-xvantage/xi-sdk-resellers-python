...
class ProductSearchRequestServicerequestRequestpreamble(BaseModel):
    """
    ProductSearchRequestServicerequestRequestpreamble
    """ # noqa: E501
    isocountrycode: StrictStr
    customernumber: StrictStr
    vendornumber: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["isocountrycode", "customernumber", "vendornumber"]
