...
class InvoiceDetailsv61ResponseSummary(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "lines": InvoiceDetailsv61ResponseSummaryLines.from_dict(obj.get("lines")) if obj.get("lines") is not None else None,
            "miscCharges": [InvoiceDetailsv61ResponseSummaryMiscChargesInner.from_dict(_item) for _item in obj.get("miscCharges")] if obj.get("miscCharges") is not None else None,
            "totals": InvoiceDetailsv61ResponseSummaryTotals.from_dict(obj.get("totals")) if obj.get("totals") is not None else None,
            "foreignFxTotals": InvoiceDetailsv61ResponseSummaryForeignFxTotals.from_dict(obj.get("foreignFxTotals")) if obj.get("foreignFxTotals") is not None else None
        })
        return _obj
