...
class OrderStatusAsyncNotificationRequestResourceInnerLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipmentDetails": [OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInner.from_dict(_item) for _item in obj.get("shipmentDetails")] if obj.get("shipmentDetails") is not None else None,
            "serialNumberDetails": [OrderStatusAsyncNotificationRequestResourceInnerLinesInnerSerialNumberDetailsInner.from_dict(_item) for _item in obj.get("serialNumberDetails")] if obj.get("serialNumberDetails") is not None else None
        })
        return _obj
