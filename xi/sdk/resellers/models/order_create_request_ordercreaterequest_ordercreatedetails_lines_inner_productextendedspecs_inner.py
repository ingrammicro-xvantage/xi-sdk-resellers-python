...
class OrderCreateRequestOrdercreaterequestOrdercreatedetailsLinesInnerProductextendedspecsInner(BaseModel):
    """
    ...
    def attributename_validate_enum(cls, value):
        ...
        if value not in set(['shipfrom', 'specialprice', 'authbidnumber', 'commenttext', 'serialnumber', 'contactnumber', 'shipnotestxt']):
            raise ValueError("must be one of enum values ('shipfrom', 'specialprice', 'authbidnumber', 'commenttext', 'serialnumber', 'contactnumber', 'shipnotestxt')")
        return value
