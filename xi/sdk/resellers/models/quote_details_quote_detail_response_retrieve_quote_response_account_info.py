...
class QuoteDetailsQuoteDetailResponseRetrieveQuoteResponseAccountInfo(BaseModel):
    """
    ...
    bcn: Optional[StrictStr] = None
    phone: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["accountName", "bcn", "phone"]
