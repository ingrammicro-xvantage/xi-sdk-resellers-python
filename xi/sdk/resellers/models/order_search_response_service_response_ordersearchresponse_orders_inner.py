...
class OrderSearchResponseServiceResponseOrdersearchresponseOrdersInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suborders": [OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerSubordersInner.from_dict(_item) for _item in obj["suborders"]] if obj.get("suborders") is not None else None,
            "links": OrderSearchResponseServiceResponseOrdersearchresponseOrdersInnerLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
