...
class OrderStatusAsyncNotificationRequestResourceInnerLinesInnerShipmentDetailsInnerPackageDetailsInner(BaseModel):
    """
    ...
    quantity_inbox: Optional[StrictStr] = Field(default=None, description="The quantity of line items in the box.", alias="quantityInbox")
    ...
    __properties: ClassVar[List[str]] = ["cartonNumber", "quantityInbox", "trackingNumber"]
