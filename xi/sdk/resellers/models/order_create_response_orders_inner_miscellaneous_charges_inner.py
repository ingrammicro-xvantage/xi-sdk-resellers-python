...
class OrderCreateResponseOrdersInnerMiscellaneousChargesInner(BaseModel):
    """
    ...
    charge_description: Optional[StrictStr] = Field(default=None, description="Description of the miscellaneous charges for the order.", alias="chargeDescription")
    charge_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total amount of miscellaneous charges for the order.", alias="chargeAmount")
