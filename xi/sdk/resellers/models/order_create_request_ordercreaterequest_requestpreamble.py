...
class OrderCreateRequestOrdercreaterequestRequestpreamble(BaseModel):
    """
    OrderCreateRequestOrdercreaterequestRequestpreamble
    """ # noqa: E501
    isocountrycode: StrictStr = Field(description="2 digit ISO country code")
    customernumber: StrictStr = Field(description="Your unique Ingram Micro customer number")
