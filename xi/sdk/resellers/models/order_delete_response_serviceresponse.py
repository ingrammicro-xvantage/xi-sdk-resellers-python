...
class OrderDeleteResponseServiceresponse(BaseModel):
    """
    OrderDeleteResponseServiceresponse
    """ # noqa: E501
    responsepreamble: Optional[OrderDeleteResponseServiceresponseResponsepreamble] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responsepreamble": OrderDeleteResponseServiceresponseResponsepreamble.from_dict(obj["responsepreamble"]) if obj.get("responsepreamble") is not None else None
        })
        return _obj
