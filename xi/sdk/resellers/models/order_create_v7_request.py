...
class OrderCreateV7Request(BaseModel):
    ...
    vmf_additional_attributes: Optional[List[OrderCreateV7RequestVmfAdditionalAttributesInner]] = Field(default=None, description="The object containing the list of fields required at a header level by the vendor.<br> This a <code>Deprecated</code> object. Kindly use <b>vmfVendorAdditionalAttributes</b> object", alias="vmfAdditionalAttributes")
    vmf_vendor_additional_attributes: Optional[List[OrderCreateV7RequestVmfVendorAdditionalAttributesInner]] = Field(default=None, description="The object containing the list of Vendor Mandatory Fields required by the vendor for the Hardware products.", alias="vmfVendorAdditionalAttributes")
    vri_additional_attributes: Optional[List[OrderCreateV7RequestVmfVendorAdditionalAttributesInner]] = Field(default=None, description="The object containing the list of Vendor Mandatory Fields required by the vendor for the subscription products.<br> Use this object ONLY when using a full quote ordering for a subsciption product. For line-level ordering use <b>vriAdditionalAttributes</b> object inside the line object. ", alias="vriAdditionalAttributes")
    lines: Optional[List[OrderCreateV7RequestLinesInner]] = None
    __properties: ClassVar[List[str]] = ["quoteNumber", "customerOrderNumber", "endCustomerOrderNumber", "notes", "billToAddressId", "specialBidNumber", "acceptBackOrder", "vendAuthNumber", "resellerInfo", "endUserInfo", "shipToInfo", "shipmentDetails", "additionalAttributes", "vmfAdditionalAttributes", "vmfVendorAdditionalAttributes", "vriAdditionalAttributes", "lines"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vmf_vendor_additional_attributes (list)
        _items = []
        if self.vmf_vendor_additional_attributes:
            for _item_vmf_vendor_additional_attributes in self.vmf_vendor_additional_attributes:
                if _item_vmf_vendor_additional_attributes:
                    _items.append(_item_vmf_vendor_additional_attributes.to_dict())
            _dict['vmfVendorAdditionalAttributes'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vmfVendorAdditionalAttributes": [OrderCreateV7RequestVmfVendorAdditionalAttributesInner.from_dict(_item) for _item in obj["vmfVendorAdditionalAttributes"]] if obj.get("vmfVendorAdditionalAttributes") is not None else None,
