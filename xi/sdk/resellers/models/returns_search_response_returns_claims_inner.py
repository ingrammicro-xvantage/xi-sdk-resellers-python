...
class ReturnsSearchResponseReturnsClaimsInner(BaseModel):
    ...
    estimated_total_value: Optional[date] = Field(default=None, description="The estimated total value of the return.", alias="estimatedTotalValue")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "links": [ReturnsSearchResponseReturnsClaimsInnerLinksInner.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj
