...
class OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerSerialnumberdetailsInner(BaseModel):
    """
    OrderDetailResponseServiceresponseOrderdetailresponseLinesInnerSerialnumberdetailsInner
    """ # noqa: E501
    serialnumber: Optional[StrictStr] = Field(default=None, description="serial number of the ordered SKU")
