...
class OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetails(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trackingDetails": [OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetailsTrackingDetailsInner.from_dict(_item) for _item in obj["trackingDetails"]] if obj.get("trackingDetails") is not None else None
        })
        return _obj
