...
class OrderDetailRequestServicerequest(BaseModel):
    """
    OrderDetailRequestServicerequest
    """ # noqa: E501
    requestpreamble: InvoiceDetailRequestServicerequestRequestpreamble
    orderdetailrequest: Optional[OrderDetailRequestServicerequestOrderdetailrequest] = None
    __properties: ClassVar[List[str]] = ["requestpreamble", "orderdetailrequest"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of orderdetailrequest
        if self.orderdetailrequest:
            _dict['orderdetailrequest'] = self.orderdetailrequest.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "orderdetailrequest": OrderDetailRequestServicerequestOrderdetailrequest.from_dict(obj.get("orderdetailrequest")) if obj.get("orderdetailrequest") is not None else None
        })
        return _obj
