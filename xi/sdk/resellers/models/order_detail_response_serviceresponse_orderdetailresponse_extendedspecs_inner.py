...
class OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner(BaseModel):
    """
    OrderDetailResponseServiceresponseOrderdetailresponseExtendedspecsInner
    """ # noqa: E501
    attributename: Optional[StrictStr] = Field(default=None, description="termscode' | 'termsdescription' | 'commenttext' are the atrribute name")
    attributevalue: Optional[StrictStr] = Field(default=None, description="values of these fields are send . termscode' | 'termsdescription' | 'commenttext' are the atrribute name")
