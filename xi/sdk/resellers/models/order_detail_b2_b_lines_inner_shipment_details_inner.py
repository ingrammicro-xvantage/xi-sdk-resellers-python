...
class OrderDetailB2BLinesInnerShipmentDetailsInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "carrierDetails": [OrderDetailB2BLinesInnerShipmentDetailsInnerCarrierDetailsInner.from_dict(_item) for _item in obj.get("carrierDetails")] if obj.get("carrierDetails") is not None else None
        })
        return _obj
