...
class PriceAndAvailabilityResponseInnerAvailabilityAvailabilityByWarehouseInnerBackOrderInfoInner(BaseModel):
    """
    PriceAndAvailabilityResponseInnerAvailabilityAvailabilityByWarehouseInnerBackOrderInfoInner
    """ # noqa: E501
    quantity: Optional[StrictInt] = Field(default=None, description="Quantity backordered.")
    eta_date: Optional[StrictStr] = Field(default=None, description="Expected availability date.", alias="etaDate")
    __properties: ClassVar[List[str]] = ["quantity", "etaDate"]
