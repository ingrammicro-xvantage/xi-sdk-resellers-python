...
class MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse(BaseModel):
    """
    MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponse
    """ # noqa: E501
    details: Optional[List[MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "details": [MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner.from_dict(_item) for _item in obj.get("details")] if obj.get("details") is not None else None
        })
        return _obj
