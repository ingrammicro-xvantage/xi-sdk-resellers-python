...
class VendorRequiredInforesponse(BaseModel):
    """
    ...
    plan_id: Optional[StrictInt] = Field(default=None, description="ID of the subscription plan", alias="planId")
    plan_name: Optional[StrictStr] = Field(default=None, description="Name of the subscription plan", alias="planName")
    response_messages: Optional[List[VendorRequiredInforesponseResponseMessagesInner]] = Field(default=None, alias="responseMessages")
    vmf_additional_attributes: Optional[List[VendorRequiredInforesponseVmfAdditionalAttributesInner]] = Field(default=None, alias="vmfAdditionalAttributes")
    vri_additional_attributes: Optional[List[VendorRequiredInforesponseVmfAdditionalAttributesInnerAdditionalAttributesInner]] = Field(default=None, alias="vriAdditionalAttributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responseMessages": [VendorRequiredInforesponseResponseMessagesInner.from_dict(_item) for _item in obj["responseMessages"]] if obj.get("responseMessages") is not None else None,
            "vmfAdditionalAttributes": [VendorRequiredInforesponseVmfAdditionalAttributesInner.from_dict(_item) for _item in obj["vmfAdditionalAttributes"]] if obj.get("vmfAdditionalAttributes") is not None else None,
            "vriAdditionalAttributes": [VendorRequiredInforesponseVmfAdditionalAttributesInnerAdditionalAttributesInner.from_dict(_item) for _item in obj["vriAdditionalAttributes"]] if obj.get("vriAdditionalAttributes") is not None else None
        })
        return _obj
