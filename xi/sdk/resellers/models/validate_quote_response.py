...
class ValidateQuoteResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "vmfAdditionalAttributes": [ValidateQuoteResponseVmfAdditionalAttributesInner.from_dict(_item) for _item in obj.get("vmfAdditionalAttributes")] if obj.get("vmfAdditionalAttributes") is not None else None,
            "lines": [ValidateQuoteResponseLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None
        })
        return _obj
