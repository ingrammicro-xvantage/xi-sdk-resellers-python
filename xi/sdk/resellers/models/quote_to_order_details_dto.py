...
class QuoteToOrderDetailsDTO(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "endUserInfo": [QuoteToOrderDetailsDTOEndUserInfoInner.from_dict(_item) for _item in obj.get("endUserInfo")] if obj.get("endUserInfo") is not None else None,
            "shipToInfo": [QuoteToOrderDetailsDTOShipToInfoInner.from_dict(_item) for _item in obj.get("shipToInfo")] if obj.get("shipToInfo") is not None else None,
            "additionalAttributes": [QuoteToOrderDetailsDTOAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None,
            "vmfadditionalAttributes": [QuoteToOrderDetailsDTOVmfadditionalAttributesInner.from_dict(_item) for _item in obj.get("vmfadditionalAttributes")] if obj.get("vmfadditionalAttributes") is not None else None,
            "lines": [QuoteToOrderDetailsDTOLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None
        })
        return _obj
