...
class OrderCancelResponseServiceresponseResponsepreamble(BaseModel):
    """
    ...
    return_code: Optional[StrictStr] = Field(default=None, alias="returnCode")
    return_message: Optional[StrictStr] = Field(default=None, alias="returnMessage")
    __properties: ClassVar[List[str]] = ["requestStatus", "returnCode", "returnMessage"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "returnMessage": obj.get("returnMessage")
        })
        return _obj
