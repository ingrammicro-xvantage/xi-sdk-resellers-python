...
class OrderCreateV7ResponseResourceOrdersInnerLinesInner(BaseModel):
    """
    ...
    ingram_part_number: Optional[Annotated[str, Field(strict=True, max_length=6)]] = Field(default=None, description="The Ingram Micro part number for the line item.", alias="ingramPartNumber")
    ...
    shipment_details: Optional[List[OrderCreateV7ResponseResourceOrdersInnerLinesInnerShipmentDetailsInner]] = Field(default=None, description="The shipment details for the line item.", alias="shipmentDetails")
    __properties: ClassVar[List[str]] = ["subOrderNumber", "ingramLineNumber", "customerLineNumber", "lineStatus", "ingramPartNumber", "unitPrice", "extendedUnitPrice", "quantityOrdered", "quantityConfirmed", "quantityBackOrdered", "notes", "shipmentDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "shipmentDetails": [OrderCreateV7ResponseResourceOrdersInnerLinesInnerShipmentDetailsInner.from_dict(_item) for _item in obj["shipmentDetails"]] if obj.get("shipmentDetails") is not None else None
        })
        return _obj
