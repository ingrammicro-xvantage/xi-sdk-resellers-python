...
class ReturnsCreateRequest(BaseModel):
    """
    ReturnsCreateRequest
    """ # noqa: E501
    list: Optional[List[ReturnsCreateRequestListInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "list": [ReturnsCreateRequestListInner.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
