...
class FreightResponseFreightEstimateResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "distribution": [FreightResponseFreightEstimateResponseDistributionInner.from_dict(_item) for _item in obj.get("distribution")] if obj.get("distribution") is not None else None,
            "lines": [FreightResponseFreightEstimateResponseLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None
        })
        return _obj
