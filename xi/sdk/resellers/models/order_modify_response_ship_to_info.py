...
class OrderModifyResponseShipToInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressId", "contact", "companyName", "addressLine1", "addressLine2", "addressLine3", "city", "state", "postalCode", "countryCode", "phoneNumber", "email"]
