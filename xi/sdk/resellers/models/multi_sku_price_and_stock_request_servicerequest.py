...
class MultiSKUPriceAndStockRequestServicerequest(BaseModel):
    """
    MultiSKUPriceAndStockRequestServicerequest
    """ # noqa: E501
    requestpreamble: Optional[MultiSKUPriceAndStockRequestServicerequestRequestpreamble] = None
    priceandstockrequest: Optional[MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "requestpreamble": MultiSKUPriceAndStockRequestServicerequestRequestpreamble.from_dict(obj.get("requestpreamble")) if obj.get("requestpreamble") is not None else None,
            "priceandstockrequest": MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest.from_dict(obj.get("priceandstockrequest")) if obj.get("priceandstockrequest") is not None else None
        })
        return _obj
