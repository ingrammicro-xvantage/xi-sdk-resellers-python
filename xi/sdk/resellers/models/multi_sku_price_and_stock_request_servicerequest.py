...
class MultiSKUPriceAndStockRequestServicerequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestpreamble": MultiSKUPriceAndStockRequestServicerequestRequestpreamble.from_dict(obj["requestpreamble"]) if obj.get("requestpreamble") is not None else None,
            "priceandstockrequest": MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest.from_dict(obj["priceandstockrequest"]) if obj.get("priceandstockrequest") is not None else None
        })
        return _obj
