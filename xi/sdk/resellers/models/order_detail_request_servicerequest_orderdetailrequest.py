...
class OrderDetailRequestServicerequestOrderdetailrequest(BaseModel):
    """
    OrderDetailRequestServicerequestOrderdetailrequest
    """ # noqa: E501
    ordernumber: StrictStr = Field(description="Ingram Micro Order Number")
    customerponumber: Optional[StrictStr] = None
    orderdate: Optional[StrictStr] = None
    systemid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ordernumber", "customerponumber", "orderdate", "systemid"]
