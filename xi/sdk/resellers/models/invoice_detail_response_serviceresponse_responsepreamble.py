...
class InvoiceDetailResponseServiceresponseResponsepreamble(BaseModel):
    """
    InvoiceDetailResponseServiceresponseResponsepreamble
    """ # noqa: E501
    responsestatus: Optional[StrictStr] = None
    statuscode: Optional[StrictStr] = None
    responsemessage: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["responsestatus", "statuscode", "responsemessage"]
