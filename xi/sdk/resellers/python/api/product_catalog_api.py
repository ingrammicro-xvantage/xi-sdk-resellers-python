...
class ProductCatalogApi:
    ...
    def post_priceandavailability(
        self,
        include_availability: Annotated[List[StrictBool], Field(description="Pass boolean value as input, if true the response will contain warehouse availability details, if false the response will not hold warehouse availability details")],
        ...
        :type include_availability: List[bool]
