...
class QuotesV4Api:
    ...
    @validate_call
    def post_v4_quotedetails(
        self,
        quote_details_request: Optional[QuoteDetailsRequest] = None,
        ...
        :param quote_details_request:
        :type quote_details_request: QuoteDetailsRequest
        ...
        _param = self._post_v4_quotedetails_serialize(
            quote_details_request=quote_details_request,
    ...
    @validate_call
    def post_v4_quotedetails_with_http_info(
        self,
        quote_details_request: Optional[QuoteDetailsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_v4_quotedetails_without_preload_content(
        self,
        quote_details_request: Optional[QuoteDetailsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_v4_quotedetails_serialize(
        self,
        ...
        if quote_details_request is not None:
            _body_params = quote_details_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/quotes/v1/quotedetails',
    ...
    def post_v4_quotesearch(
        ...
        _param = self._post_v4_quotesearch_serialize(
    ...
    @validate_call
    def post_v4_quotesearch_with_http_info(
        self,
        quote_list_request: Optional[QuoteListRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_v4_quotesearch_without_preload_content(
        self,
        quote_list_request: Optional[QuoteListRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_v4_quotesearch_serialize(
        self,
        quote_list_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/quotes/v1/quotes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
