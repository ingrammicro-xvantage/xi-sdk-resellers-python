...
class DealsApi:
    ...
    def get_resellers_v6_dealssearch(
        ...
        size: Annotated[Optional[StrictInt], Field(description="The number of records required in the call - max records 100 per page.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="The page number reference.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type deal_id: str
        :param size: The number of records required in the call - max records 100 per page.
        :type size: int
        :param page: The page number reference.
        :type page: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
