...
class AccesstokenApi:
    ...
    def get_accesstoken(
        self,
        grant_type: Annotated[StrictStr, Field(description="Keep grant_type as client_credentials only.")],
        client_id: StrictStr,
        ...
        :param grant_type: Keep grant_type as client_credentials only. (required)
        :type grant_type: str
        ...
        _param = self._get_accesstoken_serialize(
    ...
    @validate_call
    def get_accesstoken_with_http_info(
        self,
        grant_type: Annotated[StrictStr, Field(description="Keep grant_type as client_credentials only.")],
        client_id: StrictStr,
        client_secret: StrictStr,
    ...
    @validate_call
    def get_accesstoken_without_preload_content(
        self,
        grant_type: Annotated[StrictStr, Field(description="Keep grant_type as client_credentials only.")],
        client_id: StrictStr,
        client_secret: StrictStr,
    ...
    def _get_accesstoken_serialize(
        self,
        grant_type,
        client_id,
        client_secret,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/oauth/oauth20/token',
