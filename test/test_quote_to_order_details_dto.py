    ...
    def make_instance(self, include_optional) -> QuoteToOrderDetailsDTO:
        ...
        if include_optional:
            return QuoteToOrderDetailsDTO(
                ...
                bill_to_address_id = '',
                end_user_info = [
                    xi-sdk-python.models.quote_to_order_details_dto_end_user_info_inner.QuoteToOrderDetailsDTO_endUserInfo_inner(
                        company_name = '', 
                        contact = '', 
                        address_line1 = '', 
                        address_line2 = '', 
                ...
                ship_to_info = [
                    xi-sdk-python.models.quote_to_order_details_dto_ship_to_info_inner.QuoteToOrderDetailsDTO_shipToInfo_inner(
                        address_id = '', 
                        company_name = '', 
                        contact = '', 
                        address_line1 = '', 
                ...
                additional_attributes = [
                    xi-sdk-python.models.quote_to_order_details_dto_additional_attributes_inner.QuoteToOrderDetailsDTO_additionalAttributes_inner(
                        attribute_name = '', 
                        attribute_value = '', )
                    ],
                vmfadditional_attributes = [
                    xi-sdk-python.models.quote_to_order_details_dto_vmfadditional_attributes_inner.QuoteToOrderDetailsDTO_vmfadditionalAttributes_inner(
                        attribute_name = '', 
                        attribute_value = '', 
                        attribute_description = '', )
                    ],
                lines = [
                    xi-sdk-python.models.quote_to_order_details_dto_lines_inner.QuoteToOrderDetailsDTO_lines_inner(
