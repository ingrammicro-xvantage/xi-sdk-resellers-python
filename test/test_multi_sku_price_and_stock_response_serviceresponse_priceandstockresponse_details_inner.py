...
class TestMultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner:
        """Test MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner`
        """
        model = MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner()
        if include_optional:
            return MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner(
                ...
                vendorname = '',
                cpucode = '',
                var_class = 'A-Stocked product in all IM warehouses',
                skustatus = '',
                mediacpu = '',
                categorysubcategory = '',
                retailprice = 1.337,
    ...
    def testMultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner(self):
        """Test MultiSKUPriceAndStockResponseServiceresponsePriceandstockresponseDetailsInner"""
