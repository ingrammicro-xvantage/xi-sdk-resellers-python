...
class TestRenewalsSearchRequestStatusOpporutinyStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RenewalsSearchRequestStatusOpporutinyStatus:
        """Test RenewalsSearchRequestStatusOpporutinyStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenewalsSearchRequestStatusOpporutinyStatus`
        """
    ...
    def testRenewalsSearchRequestStatusOpporutinyStatus(self):
        """Test RenewalsSearchRequestStatusOpporutinyStatus"""
