    ...
    def make_instance(self, include_optional) -> FreightRequest:
        ...
        if include_optional:
            return FreightRequest(
                ...
                ship_to_address_id = '',
                ship_to_address = [
                    xi-sdk-python.models.freight_request_ship_to_address_inner.freightRequest_shipToAddress_inner(
                        company_name = '', 
                        address_line1 = '', 
                        address_line2 = '', 
                        address_line3 = '', 
                ...
                lines = [
                    xi-sdk-python.models.freight_request_lines_inner.freightRequest_lines_inner(
