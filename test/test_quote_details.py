...
class TestQuoteDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QuoteDetails:
        ...
        if include_optional:
            return QuoteDetails(
                quote_detail_response = xi-sdk-resellers-python.models.quote_details_quote_detail_response.quoteDetails_quoteDetailResponse(
                    response_preamble = xi-sdk-resellers-python.models.quote_details_quote_detail_response_response_preamble.quoteDetails_quoteDetailResponse_responsePreamble(
                        ...
                        status_code = '', 
                        response_message = '', ), 
                    retrieve_quote_response = xi-sdk-resellers-python.models.quote_details_quote_detail_response_retrieve_quote_response.quoteDetails_quoteDetailResponse_retrieveQuoteResponse(
                        quote_guid = '', 
                        quote_name = '', 
                        quote_number = '', 
