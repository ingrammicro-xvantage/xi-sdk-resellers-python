...
class TestOrderCancelResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderCancelResponse:
        """Test OrderCancelResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCancelResponse`
        """
    ...
    def testOrderCancelResponse(self):
        """Test OrderCancelResponse"""
