    ...
    def make_instance(self, include_optional) -> InvoiceDetailsv61Response:
        ...
        if include_optional:
            return InvoiceDetailsv61Response(
                ...
                ingram_order_number = '',
                notes = '',
                payment_terms_info = xi-sdk-python.models.invoice_detailsv6_1_response_payment_terms_info.InvoiceDetailsv6_1Response_paymentTermsInfo(
                    payment_terms_code = '', 
                    payment_terms_description = '', 
                    payment_terms_due_date = '', ),
                bill_to_info = xi-sdk-python.models.invoice_detailsv6_1_response_bill_to_info.InvoiceDetailsv6_1Response_billToInfo(
                    contact = '', 
                    company_name = '', 
                    address_line1 = '', 
                    address_line2 = '', 
                    ...
                    phone_number = '', 
                    email = '', ),
                ship_to_info = xi-sdk-python.models.invoice_detailsv6_1_response_ship_to_info.InvoiceDetailsv6_1Response_shipToInfo(
                    contact = '', 
                    company_name = '', 
                    address_line1 = '', 
                    address_line2 = '', 
                    ...
                    email = '', ),
                lines = [
                    xi-sdk-python.models.invoice_detailsv6_1_response_lines_inner.InvoiceDetailsv6_1Response_lines_inner(
                        ingram_line_number = '', 
                        ...
                        tax_amount = 1.337, 
                        serial_numbers = [
                            xi-sdk-python.models.invoice_detailsv6_1_response_lines_inner_serial_numbers_inner.InvoiceDetailsv6_1Response_lines_inner_serialNumbers_inner(
                                serial_number = '', )
                            ], 
                        quantity_ordered = 56, 
                        quantity_shipped = 56, )
                    ],
                fx_rate_info = xi-sdk-python.models.invoice_detailsv6_1_response_fx_rate_info.InvoiceDetailsv6_1Response_fxRateInfo(
                    currency_code = '', 
                    company_currency = '', 
                    invoice_currency = '', 
                    currency_fx_rate = 1.337, ),
                summary = xi-sdk-python.models.invoice_detailsv6_1_response_summary.InvoiceDetailsv6_1Response_summary(
