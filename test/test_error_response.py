    ...
    def make_instance(self, include_optional) -> ErrorResponse:
        ...
        if include_optional:
            return ErrorResponse(
                errors = [
                    xi-sdk-python.models.error_response_errors_inner.ErrorResponse_errors_inner(
                        id = '', 
                        type = '', 
                        message = '', 
                        fields = [
                            xi-sdk-python.models.error_response_errors_inner_fields_inner.ErrorResponse_errors_inner_fields_inner(
                                field = '', 
                                value = '', 
                                message = '', )
                            ], )
