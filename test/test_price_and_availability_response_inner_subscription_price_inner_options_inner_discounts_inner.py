...
class TestPriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner(unittest.TestCase):
    """PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner:
        """Test PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner`
        """
        model = PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner()
        if include_optional:
            return PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner(
                volume_discounts = [
    ...
    def testPriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner(self):
        """Test PriceAndAvailabilityResponseInnerSubscriptionPriceInnerOptionsInnerDiscountsInner"""
