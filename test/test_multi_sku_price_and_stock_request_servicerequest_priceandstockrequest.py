...
class TestMultiSKUPriceAndStockRequestServicerequestPriceandstockrequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest:
        """Test MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest`
        """
        model = MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest()
        if include_optional:
            return MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest(
    ...
    def testMultiSKUPriceAndStockRequestServicerequestPriceandstockrequest(self):
        """Test MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest"""
