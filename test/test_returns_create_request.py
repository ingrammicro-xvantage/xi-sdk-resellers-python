    ...
    def make_instance(self, include_optional) -> ReturnsCreateRequest:
        ...
        if include_optional:
            return ReturnsCreateRequest(
                list = [
                    xi-sdk-python.models.returns_create_request_list_inner.returnsCreateRequest_list_inner(
                        invoice_number = '', 
                        ...
                        bill_to_address_id = '', 
                        ship_from_info = [
                            xi-sdk-python.models.returns_create_request_list_inner_ship_from_info_inner.returnsCreateRequest_list_inner_shipFromInfo_inner(
                                company_name = '', 
                                contact = '', 
                                address_line1 = '', 
                                address_line2 = '', 
