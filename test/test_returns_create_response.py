...
class TestReturnsCreateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnsCreateResponse:
        """Test ReturnsCreateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsCreateResponse`
        """
        model = ReturnsCreateResponse()
        if include_optional:
            return ReturnsCreateResponse(
                returns_claims = [
                    xi.sdk.resellers.models.returns_create_response_returns_claims_inner.returnsCreateResponse_returnsClaims_inner(
                        rma_claim_id = '', 
                        case_request_number = '', 
                        reference_number = '', 
    ...
    def testReturnsCreateResponse(self):
        """Test ReturnsCreateResponse"""
