    ...
    def make_instance(self, include_optional) -> OrderModifyResponseLinesInner:
        ...
        if include_optional:
            return OrderModifyResponseLinesInner(
                ...
                shipment_details = xi-sdk-python.models.order_modify_response_lines_inner_shipment_details.OrderModifyResponse_lines_inner_shipmentDetails(
                    carrier_code = '', 
                    carrier_name = '', 
                    freight_account_number = '', ),
                additional_attributes = [
                    xi-sdk-python.models.order_modify_response_lines_inner_additional_attributes_inner.OrderModifyResponse_lines_inner_additionalAttributes_inner(
                        attribute_name = '', 
                        attribute_value = '', )
                    ],
                notes = ''
