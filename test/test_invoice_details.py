    ...
    def make_instance(self, include_optional) -> InvoiceDetails:
        ...
        if include_optional:
            return InvoiceDetails(
                serviceresponse = xi-sdk-python.models.invoice_detail_response_serviceresponse.InvoiceDetailResponse_serviceresponse(
                    responsepreamble = xi-sdk-python.models.invoice_detail_response_serviceresponse_responsepreamble.InvoiceDetailResponse_serviceresponse_responsepreamble(
                        ...
                        statuscode = '', 
                        responsemessage = '', ), 
                    invoicedetailresponse = xi-sdk-python.models.invoice_detail_response_serviceresponse_invoicedetailresponse.InvoiceDetailResponse_serviceresponse_invoicedetailresponse(
                        customernumber = '', 
                        invoicenumber = '', 
                        ...
                        weight = '', 
                        shippableswitch = '', 
                        soldto = xi-sdk-python.models.invoice_details/address_type/response.invoiceDetails.addressType.Response(
                            attention = '', 
                            name1 = '', 
                            name2 = '', 
                            addressline1 = '', 
                            ...
                            phonenumber = '', 
                            email = '', ), 
                        billto = xi-sdk-python.models.invoice_details/address_type/response.invoiceDetails.addressType.Response(
                            attention = '', 
                            name1 = '', 
                            name2 = '', 
                            addressline1 = '', 
                        ...
                        shoptoaddress = , 
                        lines = [
                            xi-sdk-python.models.invoice_details/product_line_type/response.invoiceDetails.productLineType.Response(
                                linenumber = '', 
                                linetype = '', 
                                partnumber = '', 
                                vendorpartnumber = '', 
                                ...
                                unitofmeasure = '', 
                                serialnumberdetails = [
                                    xi-sdk-python.models.product_line_type_serialnumberdetails_inner.productLineType_serialnumberdetails_inner(
                                        serialnumber = '', 
                                        deliverynumber = '', )
                                    ], 
                                trackingnumberdetails = [
                                    xi-sdk-python.models.product_line_type_trackingnumberdetails_inner.productLineType_trackingnumberdetails_inner(
                                        trackingnumber = '', )
                                    ], 
                        ...
                        miscfeeline = [
                            xi-sdk-python.models.invoice_detail_response_serviceresponse_invoicedetailresponse_miscfeeline_inner.InvoiceDetailResponse_serviceresponse_invoicedetailresponse_miscfeeline_inner(
                                code = '', 
                                description = '', 
                                chargeamount = '', )
                            ], ), )
