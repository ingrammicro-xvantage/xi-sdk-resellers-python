...
class OrderDetailB2B(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "billToInfo": OrderDetailB2BBillToInfo.from_dict(obj.get("billToInfo")) if obj.get("billToInfo") is not None else None,
            "shipToInfo": OrderDetailB2BShipToInfo.from_dict(obj.get("shipToInfo")) if obj.get("shipToInfo") is not None else None,
            "endUserInfo": OrderDetailB2BEndUserInfo.from_dict(obj.get("endUserInfo")) if obj.get("endUserInfo") is not None else None,
            "lines": [OrderDetailB2BLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None,
            "miscellaneousCharges": [OrderDetailB2BMiscellaneousChargesInner.from_dict(_item) for _item in obj.get("miscellaneousCharges")] if obj.get("miscellaneousCharges") is not None else None,
            "additionalAttributes": [OrderDetailB2BAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None
        })
        return _obj
