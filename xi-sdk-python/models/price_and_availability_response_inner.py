...
class PriceAndAvailabilityResponseInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "availability": PriceAndAvailabilityResponseInnerAvailability.from_dict(obj.get("availability")) if obj.get("availability") is not None else None,
            "reserveInventoryDetails": [PriceAndAvailabilityResponseInnerReserveInventoryDetailsInner.from_dict(_item) for _item in obj.get("reserveInventoryDetails")] if obj.get("reserveInventoryDetails") is not None else None,
            "pricing": PriceAndAvailabilityResponseInnerPricing.from_dict(obj.get("pricing")) if obj.get("pricing") is not None else None,
            "discounts": [PriceAndAvailabilityResponseInnerDiscountsInner.from_dict(_item) for _item in obj.get("discounts")] if obj.get("discounts") is not None else None,
            "bundlePartIndicator": obj.get("bundlePartIndicator"),
            "serviceFees": [PriceAndAvailabilityResponseInnerServiceFeesInner.from_dict(_item) for _item in obj.get("serviceFees")] if obj.get("serviceFees") is not None else None
        })
        return _obj
