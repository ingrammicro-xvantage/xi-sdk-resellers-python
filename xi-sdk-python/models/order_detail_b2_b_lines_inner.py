...
class OrderDetailB2BLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipmentDetails": [OrderDetailB2BLinesInnerShipmentDetailsInner.from_dict(_item) for _item in obj.get("shipmentDetails")] if obj.get("shipmentDetails") is not None else None,
            "serviceContractInfo": OrderDetailB2BLinesInnerServiceContractInfo.from_dict(obj.get("serviceContractInfo")) if obj.get("serviceContractInfo") is not None else None,
            "additionalAttributes": [OrderDetailB2BLinesInnerAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None,
            "links": [OrderDetailB2BLinesInnerLinksInner.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None,
            "estimatedDates": [OrderDetailB2BLinesInnerEstimatedDatesInner.from_dict(_item) for _item in obj.get("estimatedDates")] if obj.get("estimatedDates") is not None else None,
            "scheduleLines": [OrderDetailB2BLinesInnerScheduleLinesInner.from_dict(_item) for _item in obj.get("scheduleLines")] if obj.get("scheduleLines") is not None else None,
            "multipleShipments": [OrderDetailB2BLinesInnerMultipleShipmentsInner.from_dict(_item) for _item in obj.get("multipleShipments")] if obj.get("multipleShipments") is not None else None
        })
        return _obj
