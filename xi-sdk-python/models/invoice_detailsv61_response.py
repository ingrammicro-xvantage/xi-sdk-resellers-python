...
class InvoiceDetailsv61Response(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "paymentTermsInfo": InvoiceDetailsv61ResponsePaymentTermsInfo.from_dict(obj.get("paymentTermsInfo")) if obj.get("paymentTermsInfo") is not None else None,
            "billToInfo": InvoiceDetailsv61ResponseBillToInfo.from_dict(obj.get("billToInfo")) if obj.get("billToInfo") is not None else None,
            "shipToInfo": InvoiceDetailsv61ResponseShipToInfo.from_dict(obj.get("shipToInfo")) if obj.get("shipToInfo") is not None else None,
            "lines": [InvoiceDetailsv61ResponseLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None,
            "fxRateInfo": InvoiceDetailsv61ResponseFxRateInfo.from_dict(obj.get("fxRateInfo")) if obj.get("fxRateInfo") is not None else None,
            "summary": InvoiceDetailsv61ResponseSummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None
        })
        return _obj
