...
class RenewalsDetailsResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "referenceNumber": [RenewalsDetailsResponseReferenceNumberInner.from_dict(_item) for _item in obj.get("referenceNumber")] if obj.get("referenceNumber") is not None else None,
            "products": [RenewalsDetailsResponseProductsInner.from_dict(_item) for _item in obj.get("products")] if obj.get("products") is not None else None,
            "additionalAttributes": [RenewalsDetailsResponseAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None
        })
        return _obj
