...
class OrderCreateResponseOrdersInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "lines": [OrderCreateResponseOrdersInnerLinesInner.from_dict(_item) for _item in obj.get("lines")] if obj.get("lines") is not None else None,
            "miscellaneousCharges": [OrderCreateResponseOrdersInnerMiscellaneousChargesInner.from_dict(_item) for _item in obj.get("miscellaneousCharges")] if obj.get("miscellaneousCharges") is not None else None,
            "links": [OrderCreateResponseOrdersInnerLinksInner.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None,
            "rejectedLineItems": [OrderCreateResponseOrdersInnerRejectedLineItemsInner.from_dict(_item) for _item in obj.get("rejectedLineItems")] if obj.get("rejectedLineItems") is not None else None,
            "additionalAttributes": [OrderCreateResponseOrdersInnerAdditionalAttributesInner.from_dict(_item) for _item in obj.get("additionalAttributes")] if obj.get("additionalAttributes") is not None else None
        })
        return _obj
