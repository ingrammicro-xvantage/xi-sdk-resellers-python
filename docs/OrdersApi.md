...
[**post_async_order_create_v7**](OrdersApi.md#post_async_order_create_v7) | **POST** /resellers/v7/orders | Async Order Create
...
with xi.sdk.resellers.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OrdersApi->post_async_order_create_v7:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->post_async_order_create_v7: %s\n" % e)
```
