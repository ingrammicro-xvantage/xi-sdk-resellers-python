...
with xi-sdk-python.ApiClient(configuration) as api_client:
    ...
    api_instance = xi-sdk-python.RenewalsApi(api_client)
...
import os
import xi-sdk-python
from xi-sdk-python.models.renewals_search_request import RenewalsSearchRequest
