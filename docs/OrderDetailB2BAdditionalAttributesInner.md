...
order_detail_b2_b_additional_attributes_inner_from_dict = OrderDetailB2BAdditionalAttributesInner.from_dict(order_detail_b2_b_additional_attributes_inner_dict)
```
