...
from xi-sdk-python.models.order_create_request import OrderCreateRequest
...
with xi-sdk-python.ApiClient(configuration) as api_client:
    ...
    api_instance = xi-sdk-python.OrdersV4Api(api_client)
...
with xi-sdk-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = xi-sdk-python.OrdersV4Api(api_client)
    order_modify_request = xi-sdk-python.OrderModifyRequest() # OrderModifyRequest |  (optional)
...
with xi-sdk-python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = xi-sdk-python.OrdersV4Api(api_client)
    order_search_request = xi-sdk-python.OrderSearchRequest() # OrderSearchRequest |  (optional)
