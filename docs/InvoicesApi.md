...
from xi-sdk-python.models.invoice_detailsv61_response import InvoiceDetailsv61Response
...
with xi-sdk-python.ApiClient(configuration) as api_client:
    ...
    api_instance = xi-sdk-python.InvoicesApi(api_client)
