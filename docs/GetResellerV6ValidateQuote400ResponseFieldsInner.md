...
get_reseller_v6_validate_quote400_response_fields_inner_from_dict = GetResellerV6ValidateQuote400ResponseFieldsInner.from_dict(get_reseller_v6_validate_quote400_response_fields_inner_dict)
```
